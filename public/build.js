...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var CustomSection = function (_Component) {
		_inherits(CustomSection, _Component);

		function CustomSection(props) {
			_classCallCheck(this, CustomSection);

			var _this = _possibleConstructorReturn(this, (CustomSection.__proto__ || Object.getPrototypeOf(CustomSection)).call(this, props));

			_this.state = customState;
			return _this;
		}

		_createClass(CustomSection, [{
			key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var CustomDiv = function (_Component) {
		_inherits(CustomDiv, _Component);

		function CustomDiv(props) {
			_classCallCheck(this, CustomDiv);

			var _this = _possibleConstructorReturn(this, (CustomDiv.__proto__ || Object.getPrototypeOf(CustomDiv)).call(this, props));
	...
	exports.default = CustomDiv;


	CustomDiv.propTypes = { //ClassName.propTypes
		code: _react2.default.PropTypes.string.isRequired //propName: React.PropTypes.JsDataType.option
	};
